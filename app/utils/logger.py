...
class AgentLogger:
    ...
    def setup_logging(log_level: str = "INFO"):
        ...
        # Add File Handler (logs/agentic_service.log)
        import os
        log_dir = "logs"
        os.makedirs(log_dir, exist_ok=True)
        base_logger.add(
            os.path.join(log_dir, "agentic_service.log"),
            rotation="10 MB",
            retention="10 days",
            level="INFO",
            encoding="utf-8",
        ...
        for lib in ["uvicorn.access", "httpx", "httpcore", "langchain", "langgraph"]:
...
__all__ = ["logger", "AgentLogger", "get_logger"]
